...
export default function Welcome({ auth }){
    ...
    return(
        <>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-gray-300 min-h-screen flex flex-col justify-center items-center text-white">
                ...
                <div className="flex justify-center space-x-4">
                     ...
                     {auth.user ? (
                            <Link href={route('dashboard')} className="bg-orange-500 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded transition duration-300">
                                Painel de Controle
                            </Link>
                        ) : ( // Se o usuário não estiver autenticado
                            <>
                                <Link href={route('login')} className="bg-orange-500 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded transition duration-300">
                                    Acessar
                                </Link>
